...
- Model Freezing: NEVER modify, upgrade, downgrade, or change hardcoded Gemini API model names (e.g., `gemini-3.5-flash-lite`) or endpoints unless explicitly instructed.
